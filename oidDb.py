...
class oidDb():
    ...
    def getNextOid(self,searchOid):
        ...
        if self.firstItem:
            ...
            logging.debug('getNextOid returns 1.3.6.1.3.92.1.1.1.0 as no firstItem')
            return "1.3.6.1.3.92.1.1.1.0"
...
class oidDbItem():
    ...
    def __init__(self,oid=None,name=None,pysnmpBaseType=None,pysnmpRepresentation=None,
                      fixedValue=None,bdsRequest=None,bdsEvalString=None):
        self.oid = oid
    ...
    def __str__(self):
        ...
        if self.fixedValue != None:
            returnStr += "value         :{}\n".format(self.fixedValue)
...
if __name__ == '__main__':
    ...
    oidDefDict2 = {"oid":"1.3.6.1.2.1.1.4.0","name":"sysUpTime","pysnmpBaseType":"OctetString",
                  "fixedValue": "this value is configurable in snmpOidMapping.yml e.g. tbd@test.de"}
