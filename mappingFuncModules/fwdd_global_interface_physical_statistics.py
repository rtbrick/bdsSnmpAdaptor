    ...
    async def setOids(self,bdsJsonResponseDict,targetOidDb):
        ...
        for bdsJsonObject in bdsJsonResponseDict["objects"]:
            ...
            targetOidDb.insertOid(newOidItem = OidDbItem(
                ...
                value=bdsJsonObject["attribute"]["port_stat_if_in_octets"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"11."+str(index),
                name="ifInUcastPkts",
                pysnmpBaseType="Counter32",
                value=bdsJsonObject["attribute"]["port_stat_if_in_ucast_pkts"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"12."+str(index),
                name="ifInNUcastPkts",
                pysnmpBaseType="Counter32",
                value=bdsJsonObject["attribute"]["port_stat_if_in_non_ucast_pkts"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"13."+str(index),
                name="ifInDiscards",
                pysnmpBaseType="Counter32",
                value=bdsJsonObject["attribute"]["port_stat_if_in_discards"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"14."+str(index),
                name="ifInErrors",
                pysnmpBaseType="Counter32",
                value=bdsJsonObject["attribute"]["port_stat_if_in_errors"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"15."+str(index),
                name="ifInUnknownProtos",
                pysnmpBaseType="Counter32",
                value=bdsJsonObject["attribute"]["port_stat_if_in_unknown_protos"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"16."+str(index),
                name="ifOutOctets",
                pysnmpBaseType="Counter32",
                value=bdsJsonObject["attribute"]["port_stat_if_out_octets"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"17."+str(index),
                name="ifOutUcastPkts",
                pysnmpBaseType="Counter32",
                value=bdsJsonObject["attribute"]["port_stat_if_out_ucast_pkts"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"18."+str(index),
                name="ifOutNUcastPkts",
                pysnmpBaseType="Counter32",
                value=bdsJsonObject["attribute"]["port_stat_if_out_non_ucast_pkts"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"19."+str(index),
                name="ifOutDiscards",
                pysnmpBaseType="Counter32",
                value=bdsJsonObject["attribute"]["port_stat_if_out_discards"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"20."+str(index),
                name="ifOutErrors",
                pysnmpBaseType="Counter32",
                value=bdsJsonObject["attribute"]["port_stat_if_out_errors"]))
            targetOidDb.insertOid(newOidItem = OidDbItem(
                bdsMappingFunc = "fwdd_global_interface_physical_statistics",
                oid = oidSegment+"21."+str(index),
                name="ifOutQLen",
                pysnmpBaseType="Gauge32",
                value=bdsJsonObject["attribute"]["port_stat_if_out_qlen"]))
